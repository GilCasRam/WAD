<%-- 
    ...
    Created on : 24 ene. 2021, 22:29:50
    Author     : Jesus
--%>
...
<html>
    ...
    <body>
        ...
        <%
            CategoriaDTO dto = (CategoriaDTO) request.getAttribute("categoria");
        %>
        ...
        <div class="container">
            <div class="container title p-5">
                ...
                <h1 class="m-2">Categoría</h1>

            </div>
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title text-center"> INFORMACIÓN DE LA CATEGORIA</h4> 
                    ...
                    <div>
                        <a class="btn btn-secondary mt-4 pr-4 pl-4" 
                           href="Categoria_Servlet?accion=listaDeCategorias">REGRESAR</a>
                    </div>
                </div>
            </div>          
        </div>
