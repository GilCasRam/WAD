    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="container title p-5">
                ...
                <div class="container">
                    <a class="btn btn-primary m-2 col-6" href="Usuario_Servlet?accion=nuevo">Agregar Usuario</a>

                    <a class="btn btn-info m-2 col-6" href="Usuario_Servlet?accion=verPDF">Ver Reporte</a>
                </div>
        ...
        <div class="container col-11">
            ...
            <table class="table table-responsive table-dark table-hover table-striped">    
                ...
                <tr>
                    <td scope="row"><a class="btn btn-primary btn-xs" href="Usuario_Servlet?accion=ver&id=<%= idUsuario%>"><%=idUsuario%></a></td>
                    <td><%= nombre%></td>
                    <td><%= nombreUsuario%></td>
                    <td><%= claveUsuario%></td>
                    <td><%= email%></td>
