<%-- 
    ...
    Created on : 24 ene. 2021, 22:28:19
    Author     : Jesus
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ProductoDTO dto = (ProductoDTO) request.getAttribute("producto");
        ...
        <div class="container">
            <div class="container title p-5">
                ...
                <h1 class="m-2">Producto</h1>

            </div>
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title text-center"> INFORMACIÓN DEL PRODUCTO</h4> 
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-5 bmr-5">
                            <%=dto.getEntidad().getIdCategoria().getIdCategoria()%>
                        </div>
                    </div>
                    <div>
                        <a class="btn btn-secondary mt-4 pr-4 pl-4" 
                           href="Producto_Servlet?accion=listaDeProductos">REGRESAR</a>
                    </div>
                </div>
            </div>          
        </div>
