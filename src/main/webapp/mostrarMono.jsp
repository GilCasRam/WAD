<%-- 
    Document   : mostrarMono
    Created on : 24 ene. 2021, 22:31:39
    Author     : Jesus
--%>
...
<html>
    ...
    <body>
        ...
        <%
            Mono_BioDTO dto = (Mono_BioDTO) request.getAttribute("mono");
        ...
        <div class="container">
            <div class="container title p-5">
                ...
                <h1 class="m-2">Monografía y Biografía</h1>

            </div>
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title text-center"> INFORMACIÓN DE LA MONOGRAFÍA o BIOGRAFÍA</h4> 
                    ...
                    <div>
                        <a class="btn btn-secondary mt-4 pr-4 pl-4" 
                           href="Mono_Bio_Servlet?accion=listaDeMono">REGRESAR</a>
                    </div>
                </div>
            </div>          
        </div>
