<%-- 
    Document   : monoForm
    Created on : 24-ene-2021, 0:30:38
    Author     : Juan
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container col-6 p-5">
            ...
            <form action="Mono_Bio_Servlet?accion=guardar" method="post" id="Formulario">
                 
                <div class="form-group">
                    <label for="sdf">Clave</label>
                    <input type="text" class="form-control" name="claveMono" id="claveMono" required>
                </div>
                ...
                <button type="submit" class="btn btn-primary mb-2 col-12" href="Mono_Bio_Servlet?accion=guardar">Enviar</button>
            </form>
